...
# using SimplePosets
# @time GenerateLinext.generate_linext(BooleanLattice(parse(Int, "11")))
# @profview GenerateLinext.generate_linext(BooleanLattice(parse(Int, "11")))